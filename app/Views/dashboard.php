            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start pl-3">
                ...
                <div>
                    <a class="navbar-brand brand-logo" href="../../index.html">
                        <img src="<?= base_url() ?>/public/images/bobapeer-03.png" alt="Favicon">
                    </a>
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text">Bobapeer<span class="text-black fw-bold"></span></h1>
                        <p>Silahkan pilih minuman favoritnya ya... </p>
                    </li>
                </ul>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Pesanan Berhasil dibuat. atas nama <b id="namaPemesan">
                                    <br> <br> Mohon Menunggu sebentar ya <br> <br>
                                    <b>Terimakasih... :)</b><br><br>
                                    <i>langsung dibayar ya.. </i>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-warning" onclick="tutupModalSelesai()">Baik</button>
                            </div>
                        </div>
                    </div>
                </div>
